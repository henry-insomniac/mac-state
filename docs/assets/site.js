const pageTranslations = {
  "zh-CN": {
    ...
    storyOneTitle: "只显示真正重要的内容",
    storyOneBody:
      "用户可以隐藏不需要的 dashboard 模块，重新排序保留下来的部分，让弹出面板保持短而清楚。",
    storyTwoTitle: "更早发现问题",
    storyTwoBody:
      "本地告警已经覆盖 CPU、内存、电池和磁盘活动，并提供冷却时间和最近告警历史。",
    storyThreeTitle: "不止是一个 demo",
    storyThreeBody:
      "实时历史、24 小时聚合、CSV 导出、Widget 快照和正式图标系统，让这个项目开始具备产品感而不是原型感。",
    downloadEyebrow: "发布",
    downloadBody:
  ...
  en: {
    ...
    storyOneTitle: "Show only what matters",
    storyOneBody:
      "Users can hide dashboard modules they do not need, reorder the ones they keep, and keep the popover short instead of overloaded.",
    storyTwoTitle: "Catch problems earlier",
    storyTwoBody:
      "Local alerts already cover CPU, memory, battery, and disk activity, with cooldown handling and recent alert history inside the app.",
    storyThreeTitle: "More than a demo",
    storyThreeBody:
      "Live history, 24-hour aggregates, CSV export, widget snapshots, and a proper icon system make the project feel like a product rather than a prototype.",
